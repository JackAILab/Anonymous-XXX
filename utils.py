...
class MyDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, json_file, json_mutiID_file, tokenizer, size=512, t_drop_rate=0.05, i_drop_rate=0.05, ti_drop_rate=0.05, \
        ...
        self.data_multi = json.load(open(json_mutiID_file))
    ...
    def __getitem__(self, idx):
        ...
        item = self.data[idx]
        text_origin = item["vqa_llva_face_caption"]
...
def parse_args():
    ...
    parser.add_argument(
        "--data_json_file",
        type=str,
        default="./JSON_all.json",
        required=False,
    )
    parser.add_argument(
        "--data_json_mutiID_file",
        type=str,
        default="./JSON_mutiID_all.json",
        required=False,
    )    
    parser.add_argument(
        "--image_encoder_path",
        type=str,
        default="./CLIP-ViT-H-14-laion2B-s32B-b79K",
        required=False,
