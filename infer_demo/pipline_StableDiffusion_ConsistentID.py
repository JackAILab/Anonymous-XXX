...
class ConsistentIDStableDiffusionPipeline(StableDiffusionPipeline):
    ...
    def load_ConsistentID_model(
        ...
        **kwargs,
        ...
        ### BiSeNet
        self.bise_net = None # BiSeNet(n_classes = 19)
        self.bise_net.cuda()
        self.bise_net_cp='./79999_iter.pth'
        ...
        ### LLVA Optional
        self.llva_model_path = "./llava-v1.5-7b"
        self.llva_prompt = "Describe this person's facial features for me, including face, ears, eyes, nose, and mouth." 
        self.llva_tokenizer, self.llva_model, self.llva_image_processor, self.llva_context_len = None # load_pretrained_model(self.llva_model_path)
